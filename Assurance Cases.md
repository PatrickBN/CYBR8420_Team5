...
Debaris Ezumah - This assignment was a fun one that had me dive deeper into my last deliverable. Realizing that the basis securing anything in business is documentation, and contracts. Without either business doesn't materialze. I think the overall teamwork is great with everyone informing each other about what we can do and finish within an alloted time frame. The team is coming together to get the job done. Overall it was hard, but there's nothing like a challenge right? :]
